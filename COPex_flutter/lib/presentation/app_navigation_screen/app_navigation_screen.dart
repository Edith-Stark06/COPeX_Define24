                ...
                child: SingleChildScrollView(
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        _buildScreenTitle(
                          screenTitle: "msg_iphone_11_pro".tr,
                        ),
                        _buildScreenTitle(
                          screenTitle: "msg_iphone_11_pro2".tr,
                        ),
                        _buildScreenTitle(
                          screenTitle: "msg_iphone_11_pro3".tr,
                        ),
                        _buildScreenTitle(
                          screenTitle: "msg_iphone_11_pro4".tr,
                        ),
                        _buildScreenTitle(
                          screenTitle: "msg_iphone_11_pro5".tr,
                        )
                      ],
                    ),
                  ),
